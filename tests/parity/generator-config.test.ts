...
describe("xray parity generator config", () => {
  it("records the codegen config, release inputs, and output intent in the generated manifest", () => {
    ...
    expect(xrayParityManifest.source.selectedTags).toEqual(["v25.10.15", "v26.4.25", "v26.5.3", "v26.6.22", "v26.6.27", "v26.7.11"]);
    expect(xrayParityManifest.source.tags).toEqual(["v25.10.15", "v26.4.25", "v26.5.3", "v26.6.22", "v26.6.27", "v26.7.11"]);
